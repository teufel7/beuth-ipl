   ...
   0000 02 00 33           1349 	ljmp	__sdcc_gsinit_startup
   0003 32                 1350 	reti
   0004                    1351 	.ds	7
   000B 32                 1352 	reti
   000C                    1353 	.ds	7
   ...
   0023 32                 1358 	reti
   0024                    1359 	.ds	7
   002B 02 07 FF           1360 	ljmp	_SHINT_viXINTR5Isr
                           1361 ;--------------------------------------------------------
                           ...
                           1368 	.globl __sdcc_gsinit_startup
                           1369 	.globl __sdcc_program_startup
                           1370 	.globl __start__stack
                           1371 	.globl __xc800_genXINIT
                           1372 	.globl __xc800_genXRAMCLEAR
                           1373 	.globl __xc800_genRAMCLEAR
                           1374 	.area GSFINAL (CODE)
   0094 02 00 2E           1375 	ljmp	__sdcc_program_startup
                           1376 ;--------------------------------------------------------
                           1377 ; Home
                           1378 ;--------------------------------------------------------
                           1379 	.area HOME    (CODE)
                           1380 	.area HOME    (CODE)
   002E                    1381 __sdcc_program_startup:
   002E 12 00 BB           1382 	lcall	_main
                           1383 ;	return from main will lock up
   0031 80 FE              1384 	sjmp .
                           1385 ;--------------------------------------------------------
                           1386 ; code
                           1387 ;--------------------------------------------------------
                           1388 	.area CSEG    (CODE)
                           1389 ;------------------------------------------------------------
                           1390 ;Allocation info for local variables in function 'MAIN_vInit'
                           1391 ;------------------------------------------------------------
                           1392 ;------------------------------------------------------------
                    0000   1393 	G$MAIN_vInit$0$0 ==.
                    0000   1394 	C$MAIN.C$122$0$0 ==.
                           1395 ;	../MAIN.C:122: void MAIN_vInit(void)
                           1396 ;	-----------------------------------------
                           1397 ;	 function MAIN_vInit
                           1398 ;	-----------------------------------------
   0097                    1399 _MAIN_vInit:
                    0002   1400 	ar2 = 0x02
                    0003   1401 	ar3 = 0x03
                    0004   1402 	ar4 = 0x04
                    0005   1403 	ar5 = 0x05
                    ...
                    0000   1406 	ar0 = 0x00
                    0001   1407 	ar1 = 0x01
                    0000   1408 	C$MAIN.C$138$1$1 ==.
                           1409 ;	../MAIN.C:138: SFR_PAGE(_su1, noSST);         // switch to page1
   0097 75 BF 01           1410 	mov	_SCU_PAGE,#0x01
                    0003   1411 	C$MAIN.C$140$1$1 ==.
                           1412 ;	../MAIN.C:140: CMCON         =  0x10;         // load Clock Control Register
   009A 75 BA 10           1413 	mov	_CMCON,#0x10
                    0006   1414 	C$MAIN.C$142$1$1 ==.
                           1415 ;	../MAIN.C:142: SFR_PAGE(_su0, noSST);         // switch to page0
   009D 75 BF 00           1416 	mov	_SCU_PAGE,#0x00
                    0009   1417 	C$MAIN.C$151$1$1 ==.
                           1418 ;	../MAIN.C:151: IO_vInit();
   00A0 12 07 F1           1419 	lcall	_IO_vInit
                    000C   1420 	C$MAIN.C$154$1$1 ==.
                           1421 ;	../MAIN.C:154: T2_vInit();
   00A3 12 08 9F           1422 	lcall	_T2_vInit
                    000F   1423 	C$MAIN.C$157$1$1 ==.
                           1424 ;	../MAIN.C:157: CAN_vInit();
   00A6 12 00 C0           1425 	lcall	_CAN_vInit
                    0012   1426 	C$MAIN.C$160$1$1 ==.
                           1427 ;	../MAIN.C:160: SHINT_vInit();
   00A9 12 07 F8           1428 	lcall	_SHINT_vInit
                    0015   1429 	C$MAIN.C$164$1$1 ==.
                           1430 ;	../MAIN.C:164: IP            =  0x00;         // load Interrupt Priority Register
   00AC 75 B8 00           1431 	mov	_IP,#0x00
                    0018   1432 	C$MAIN.C$165$1$1 ==.
                           1433 ;	../MAIN.C:165: IPH           =  0x00;         // load Interrupt Priority High Register
   00AF 75 B9 00           1434 	mov	_IPH,#0x00
                    001B   1435 	C$MAIN.C$166$1$1 ==.
                           1436 ;	../MAIN.C:166: IP1           =  0x00;         // load Interrupt Priority 1 Register
   00B2 75 F8 00           1437 	mov	_IP1,#0x00
                    001E   1438 	C$MAIN.C$167$1$1 ==.
                           1439 ;	../MAIN.C:167: IPH1          =  0x00;         // load Interrupt Priority 1 High Register
   00B5 75 F9 00           1440 	mov	_IPH1,#0x00
                    0021   1441 	C$MAIN.C$179$1$1 ==.
                           1442 ;	../MAIN.C:179: EA            =  1;           
   00B8 D2 AF              1443 	setb	_EA
                    0023   1444 	C$MAIN.C$181$1$1 ==.
                    0023   1445 	XG$MAIN_vInit$0$0 ==.
   00BA 22                 1446 	ret
                           1447 ;------------------------------------------------------------
                           1448 ;Allocation info for local variables in function 'main'
                           1449 ;------------------------------------------------------------
                           1450 ;------------------------------------------------------------
                    0024   1451 	G$main$0$0 ==.
                    0024   1452 	C$MAIN.C$205$1$1 ==.
                           1453 ;	../MAIN.C:205: void main(void)
                           1454 ;	-----------------------------------------
                           1455 ;	 function main
                           1456 ;	-----------------------------------------
   00BB                    1457 _main:
                    0024   1458 	C$MAIN.C$211$1$1 ==.
                           1459 ;	../MAIN.C:211: MAIN_vInit();
   00BB 12 00 97           1460 	lcall	_MAIN_vInit
                    0027   1461 	C$MAIN.C$217$1$1 ==.
                           1462 ;	../MAIN.C:217: while(1)
   00BE                    1463 00102$:
                    0027   1464 	C$MAIN.C$226$1$1 ==.
                    0027   1465 	XG$main$0$0 ==.
   00BE 80 FE              1466 	sjmp	00102$
                           1467 	.area CSEG    (CODE)
                           1468 	.area CONST   (CODE)
                           1469 	.area XINIT   (CODE)
                           1470 	.area CABS    (ABS,CODE)
