...
; This file was generated Thu Nov 28 10:57:44 2019
;--------------------------------------------------------
	.module T2
...
_T2_vInit:
	...
	ar1 = 0x01
	C$T2.C$152$1$1 ==.
;	../T2.C:152: T2_T2LH       =  0x48AC;       // load timer 2 reload/capture register low 
	mov	_T2_T2LH,#0xAC
	mov	(_T2_T2LH >> 8),#0x48
	C$T2.C$155$1$1 ==.
;	../T2.C:155: T2_RC2LH      =  0x48AC;       // load timer 2 reload/capture register low 
	mov	_T2_RC2LH,#0xAC
	mov	(_T2_RC2LH >> 8),#0x48
	C$T2.C$157$1$1 ==.
;	../T2.C:157: T2_T2MOD      =  0x1E;         // load timer 2 mode register
	mov	_T2_T2MOD,#0x1E
	C$T2.C$164$1$1 ==.
;	../T2.C:164: TR2 = 1; //   start timer
	setb	_TR2
	C$T2.C$166$1$1 ==.
	XG$T2_vInit$0$0 ==.
	ret
