...
;	../MAIN.C:154: T2_vInit();
	lcall	_T2_vInit
	C$MAIN.C$157$1$1 ==.
;	../MAIN.C:157: CAN_vInit();
	lcall	_CAN_vInit
	C$MAIN.C$160$1$1 ==.
;	../MAIN.C:160: SHINT_vInit();
	lcall	_SHINT_vInit
	C$MAIN.C$164$1$1 ==.
;	../MAIN.C:164: IP            =  0x00;         // load Interrupt Priority Register
	mov	_IP,#0x00
	C$MAIN.C$165$1$1 ==.
;	../MAIN.C:165: IPH           =  0x00;         // load Interrupt Priority High Register
	mov	_IPH,#0x00
	C$MAIN.C$166$1$1 ==.
;	../MAIN.C:166: IP1           =  0x00;         // load Interrupt Priority 1 Register
	mov	_IP1,#0x00
	C$MAIN.C$167$1$1 ==.
;	../MAIN.C:167: IPH1          =  0x00;         // load Interrupt Priority 1 High Register
	mov	_IPH1,#0x00
	C$MAIN.C$179$1$1 ==.
;	../MAIN.C:179: EA            =  1;           
	setb	_EA
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$MAIN.C$205$1$1 ==.
;	../MAIN.C:205: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$MAIN.C$211$1$1 ==.
;	../MAIN.C:211: MAIN_vInit();
	lcall	_MAIN_vInit
	C$MAIN.C$217$1$1 ==.
;	../MAIN.C:217: while(1)
00102$:
