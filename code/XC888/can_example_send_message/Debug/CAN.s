...
; This file was generated Thu Nov 28 10:57:42 2019
;--------------------------------------------------------
	.module CAN
...
;	../CAN.C:295: CAN_ADCON = ADR_DEC;         // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$304$1$1 ==.
;	../CAN.C:304: CAN_vWriteAMData(0xC48C0000); // load MO0 arbitration register
	mov	dptr,#0x0000
	mov	b,#0x8C
	mov	a,#0xC4
	lcall	_CAN_vWriteAMData
...
;	../CAN.C:315: CAN_ADCON = ADR_DEC;         // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$319$1$1 ==.
;	../CAN.C:319: CAN_vWriteAMData(0x000000DE); // load MO0 data register low
	mov	dptr,#(0xDE&0x00ff)
	clr	a
	mov	b,a
	lcall	_CAN_vWriteAMData
	C$CAN.C$322$1$1 ==.
...
;------------------------------------------------------------
	...
	C$CAN.C$589$1$1 ==.
;	../CAN.C:589: void CAN_vSetListCommand(ulong ulVal)
;	-----------------------------------------
;	 function CAN_vSetListCommand
;	-----------------------------------------
_CAN_vSetListCommand:
	C$CAN.C$591$1$1 ==.
;	../CAN.C:591: CAN_vWriteAMData(ulVal);  // - load Panel Control Register
	lcall	_CAN_vWriteAMData
	C$CAN.C$592$1$1 ==.
;	../CAN.C:592: CAN_DATA1 = CAN_PANCTR_BUSY;
	mov	_CAN_DATA1,#0x01
	C$CAN.C$593$1$1 ==.
;	../CAN.C:593: while(CAN_DATA1 & CAN_PANCTR_BUSY){ // wait until Panel has finished the 
00101$:
	mov	a,_CAN_DATA1
	jnb	acc.0,00104$
	C$CAN.C$595$2$2 ==.
;	../CAN.C:595: CAN_ADCON &= ~0x01;       
	anl	_CAN_ADCON,#0xFE
	sjmp	00101$
00104$:
	C$CAN.C$597$1$1 ==.
...
;------------------------------------------------------------
	...
	C$CAN.C$627$1$1 ==.
;	../CAN.C:627: void CAN_vGetMsgObj(ubyte ubObjNr, stCAN_SWObj *pstObj)
;	-----------------------------------------
...
_CAN_vGetMsgObj:
	mov	r2,dpl
	C$CAN.C$631$1$1 ==.
;	../CAN.C:631: CAN_pushAMRegs();    //   PUSH the CAN Access Mediator Register
00101$:
	mov	a,_CAN_ADCON
	jb	acc.1,00101$
	 push 0xD9 push 0xDA push 0xDB push 0xDC push 0xDD push 0xDE 
	C$CAN.C$635$1$1 ==.
;	../CAN.C:635: CAN_vWriteCANAddress(CAN_MOFCR(ubObjNr));
	mov	a,r2
	swap	a
	rr	a
	anl	a,#0xf8
	...
	mov	_CAN_ADH,r6
	C$CAN.C$636$1$1 ==.
;	../CAN.C:636: CAN_vReadEN();   // Readmode is Enabled
	mov	_CAN_ADCON,#0x00
00104$:
	mov	a,_CAN_ADCON
	jb	acc.1,00104$
	C$CAN.C$638$1$1 ==.
;	../CAN.C:638: pstObj->ubMOdlc  =  CAN_DATA3;//MOFCRn[31-24] DLC
	...
	lcall	__gptrput
	C$CAN.C$641$1$1 ==.
;	../CAN.C:641: CAN_vWriteCANAddress(CAN_MODATAL(ubObjNr));
	mov	a,#0x04
	...
	mov	_CAN_ADH,r1
	C$CAN.C$643$1$1 ==.
;	../CAN.C:643: CAN_vReadEN();  // Readmode is Enabled
	mov	_CAN_ADCON,#0x00
00107$:
	mov	a,_CAN_ADCON
	jb	acc.1,00107$
	C$CAN.C$644$1$1 ==.
;	../CAN.C:644: pstObj->ulDATAL.ubDB[0] = CAN_DATA0; // Read CAN Data Register 0
	mov	a,#0x0A
	add	a,r5
	mov	r0,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$645$1$1 ==.
;	../CAN.C:645: pstObj->ulDATAL.ubDB[1] = CAN_DATA1; // Read CAN Data Register 1
	mov	a,#0x0A
	add	a,r5
	...
	lcall	__gptrput
	C$CAN.C$646$1$1 ==.
;	../CAN.C:646: pstObj->ulDATAL.ubDB[2] = CAN_DATA2; // Read CAN Data Register 2
	mov	a,#0x02
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r3,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$647$1$1 ==.
;	../CAN.C:647: pstObj->ulDATAL.ubDB[3] = CAN_DATA3; // Read CAN Data Register 3
	mov	a,#0x03
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r3,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$650$1$1 ==.
;	../CAN.C:650: CAN_ADCON = ADR_INC;
	mov	_CAN_ADCON,#0x04
	C$CAN.C$654$1$1 ==.
;	../CAN.C:654: CAN_vReadEN();  // Readmode is Enabled
	mov	_CAN_ADCON,#0x00
	C$CAN.C$748$1$1 ==.
;	../CAN.C:748: CAN_popAMRegs();    //   POP the CAN Access Mediator Register
	C$CAN.C$654$1$1 ==.
;	../CAN.C:654: CAN_vReadEN();  // Readmode is Enabled
00110$:
	mov	a,_CAN_ADCON
	jb	acc.1,00110$
	C$CAN.C$655$1$1 ==.
;	../CAN.C:655: pstObj->ulDATAH.ubDB[0] = CAN_DATA0; // Read CAN Data Register 0
	mov	a,#0x0E
	add	a,r5
	mov	r0,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$656$1$1 ==.
;	../CAN.C:656: pstObj->ulDATAH.ubDB[1] = CAN_DATA1; // Read CAN Data Register 1
	mov	a,#0x0E
	add	a,r5
	mov	r3,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$657$1$1 ==.
;	../CAN.C:657: pstObj->ulDATAH.ubDB[2] = CAN_DATA2; // Read CAN Data Register 2
	mov	a,#0x02
	add	a,r3
	mov	r5,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$658$1$1 ==.
;	../CAN.C:658: pstObj->ulDATAH.ubDB[3] = CAN_DATA3; // Read CAN Data Register 3
	mov	a,#0x03
	add	a,r3
	mov	r3,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$661$1$1 ==.
;	../CAN.C:661: CAN_vWriteCANAddress(CAN_MOCTR(ubObjNr));
	mov	a,#0x07
	add	a,_CAN_vGetMsgObj_sloc1_1_0
	mov	_CAN_ADL,a
	mov	a,#0x07
	...
	mov	_CAN_ADH,r5
	C$CAN.C$662$1$1 ==.
;	../CAN.C:662: CAN_vReadEN();   // Readmode is Enabled
	mov	_CAN_ADCON,#0x00
	C$CAN.C$748$1$1 ==.
;	../CAN.C:748: CAN_popAMRegs();    //   POP the CAN Access Mediator Register
	pop	ar7
...
00113$:
	...
	jb	acc.1,00113$
	C$CAN.C$664$1$1 ==.
;	../CAN.C:664: if(CAN_DATA1 & 0x08)   // if transmit object (MOSTAT_DIR)
	mov	a,_CAN_DATA1
	jnb	acc.3,00117$
	C$CAN.C$666$1$1 ==.
;	../CAN.C:666: pstObj->ubMOcfg  = (pstObj->ubMOcfg | 0x08);  // set DIR
	push	ar2
	push	ar4
	mov	a,#0x01
	add	a,r5
...
00117$:
	C$CAN.C$672$1$1 ==.
;	../CAN.C:672: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$673$1$1 ==.
;	../CAN.C:673: CAN_vReadEN();   // ReadMode is Enabled
	mov	_CAN_ADCON,#0x00
00118$:
	mov	a,_CAN_ADCON
	jb	acc.1,00118$
	C$CAN.C$675$1$1 ==.
;	../CAN.C:675: if(CAN_DATA3 & 0x20)   // if extended identifier
	mov	a,_CAN_DATA3
	jb	acc.5,00162$
	ljmp	00128$
00162$:
	C$CAN.C$679$1$1 ==.
;	../CAN.C:679: pstObj->ulID.ubDB[0] = CAN_DATA0;   // MOARn[7-0]
	push	ar2
	push	ar4
	mov	a,#0x02
	add	a,r5
	...
	lcall	__gptrput
	C$CAN.C$680$2$3 ==.
;	../CAN.C:680: pstObj->ulID.ubDB[1] = CAN_DATA1;   // MOARn[15-8]
	mov	a,#0x02
	add	a,r5
	mov	_CAN_vGetMsgObj_sloc0_1_0,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$681$2$3 ==.
;	../CAN.C:681: pstObj->ulID.ubDB[2] = CAN_DATA2;   // MOARn[23-16]
	mov	a,#0x02
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$682$2$3 ==.
;	../CAN.C:682: pstObj->ulID.ubDB[3] = (CAN_DATA3 & 0x1f);  // MOARn[31-24]
	mov	a,#0x03
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$685$2$3 ==.
;	../CAN.C:685: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$688$2$3 ==.
;	../CAN.C:688: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$691$2$3 ==.
;	../CAN.C:691: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$693$2$3 ==.
;	../CAN.C:693: CAN_vReadEN();   // ReadMode is Enabled
	mov	_CAN_ADCON,#0x00
	C$CAN.C$748$1$1 ==.
;	../CAN.C:748: CAN_popAMRegs();    //   POP the CAN Access Mediator Register
	pop	ar4
...
00121$:
	...
	jb	acc.1,00121$
	C$CAN.C$696$1$1 ==.
;	../CAN.C:696: pstObj->ulMask.ubDB[0] = CAN_DATA0;   // MOAMRn[7-0]
	push	ar2
	push	ar4
	mov	a,#0x06
	add	a,r5
	...
	lcall	__gptrput
	C$CAN.C$697$2$3 ==.
;	../CAN.C:697: pstObj->ulMask.ubDB[1] = CAN_DATA1;   // MOAMRn[15-8]
	mov	a,#0x06
	add	a,r5
	mov	_CAN_vGetMsgObj_sloc0_1_0,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$698$2$3 ==.
;	../CAN.C:698: pstObj->ulMask.ubDB[2] = CAN_DATA2;   // MOAMRn[23-16]
	mov	a,#0x02
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$699$2$3 ==.
;	../CAN.C:699: pstObj->ulMask.ubDB[3] = (CAN_DATA3 & 0x1f);      // MOAMRn[31-24]
	mov	a,#0x03
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$701$2$3 ==.
;	../CAN.C:701: pstObj->ubMOcfg  = (pstObj->ubMOcfg | 0x04);      // set IDE 29-bit
	mov	a,#0x01
	add	a,r5
	mov	r2,a
	clr	a
...
00128$:
	C$CAN.C$706$1$1 ==.
;	../CAN.C:706: pstObj->ulID.ubDB[0] = (CAN_DATA2 & 0xFC) >> 2;   // MOARn[23-16]
	push	ar2
	push	ar4
	mov	a,#0x02
	add	a,r5
	...
	lcall	__gptrput
	C$CAN.C$707$2$4 ==.
;	../CAN.C:707: pstObj->ulID.ubDB[1] = (CAN_DATA3 & 0x1f);        // MOARn[31-24]
	mov	a,#0x02
	add	a,r5
	mov	_CAN_vGetMsgObj_sloc0_1_0,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$708$2$4 ==.
;	../CAN.C:708: pstObj->ulID.ubDB[2] = 0x00;    // MOARn[15-8]
	mov	a,#0x02
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r3,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$709$2$4 ==.
;	../CAN.C:709: pstObj->ulID.ubDB[3] = 0x00;    // MOARn[15-8]
	mov	a,#0x03
	add	a,_CAN_vGetMsgObj_sloc0_1_0
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$712$2$4 ==.
;	../CAN.C:712: ubTemp = ((pstObj->ulID.ubDB[1]) & 0x03) << 6;
	mov	dpl,_CAN_vGetMsgObj_sloc2_1_0
	mov	dph,(_CAN_vGetMsgObj_sloc2_1_0 + 1)
	mov	b,(_CAN_vGetMsgObj_sloc2_1_0 + 2)
	lcall	__gptrget
	...
	C$CAN.C$713$2$4 ==.
;	../CAN.C:713: pstObj->ulID.ubDB[1] = (pstObj->ulID.ubDB[1] >> 2);
	mov	dpl,_CAN_vGetMsgObj_sloc2_1_0
	mov	dph,(_CAN_vGetMsgObj_sloc2_1_0 + 1)
	mov	b,(_CAN_vGetMsgObj_sloc2_1_0 + 2)
	lcall	__gptrget
	...
	lcall	__gptrput
	C$CAN.C$714$2$4 ==.
;	../CAN.C:714: pstObj->ulID.ubDB[0] = (pstObj->ulID.ubDB[0] + ubTemp);
	mov	a,#0x02
	add	a,r5
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$717$2$4 ==.
;	../CAN.C:717: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$720$2$4 ==.
;	../CAN.C:720: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$723$2$4 ==.
;	../CAN.C:723: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$725$2$4 ==.
...
00124$:
	...
	jb	acc.1,00124$
	C$CAN.C$729$1$1 ==.
;	../CAN.C:729: pstObj->ulMask.ubDB[0] = (CAN_DATA2 & 0xFC) >> 2;   // MOARn[23-16]
	push	ar2
	push	ar4
	mov	a,#0x06
	add	a,r5
	...
	lcall	__gptrput
	C$CAN.C$730$2$4 ==.
;	../CAN.C:730: pstObj->ulMask.ubDB[1] = (CAN_DATA3 & 0x1f);        // MOARn[31-24]
	mov	a,#0x06
	add	a,r5
	mov	_CAN_vGetMsgObj_sloc2_1_0,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$731$2$4 ==.
;	../CAN.C:731: pstObj->ulMask.ubDB[2] = 0x00;    // MOARn[15-8]
	mov	a,#0x02
	add	a,_CAN_vGetMsgObj_sloc2_1_0
	mov	r3,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$732$2$4 ==.
;	../CAN.C:732: pstObj->ulMask.ubDB[3] = 0x00;    // MOARn[15-8]
	mov	a,#0x03
	add	a,_CAN_vGetMsgObj_sloc2_1_0
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$735$2$4 ==.
;	../CAN.C:735: ubTemp = ((pstObj->ulMask.ubDB[1]) & 0x03) << 6;
	mov	dpl,_CAN_vGetMsgObj_sloc0_1_0
	mov	dph,(_CAN_vGetMsgObj_sloc0_1_0 + 1)
	mov	b,(_CAN_vGetMsgObj_sloc0_1_0 + 2)
	lcall	__gptrget
	...
	mov	_CAN_vGetMsgObj_ubTemp_1_1,a
	C$CAN.C$736$2$4 ==.
;	../CAN.C:736: pstObj->ulMask.ubDB[1] = (pstObj->ulMask.ubDB[1] >> 2);
	mov	dpl,_CAN_vGetMsgObj_sloc0_1_0
	mov	dph,(_CAN_vGetMsgObj_sloc0_1_0 + 1)
	mov	b,(_CAN_vGetMsgObj_sloc0_1_0 + 2)
	lcall	__gptrget
	...
	lcall	__gptrput
	C$CAN.C$737$2$4 ==.
;	../CAN.C:737: pstObj->ulMask.ubDB[0] = (pstObj->ulMask.ubDB[0] + ubTemp);
	mov	a,#0x06
	add	a,r5
	mov	r2,a
	clr	a
...
00129$:
	C$CAN.C$742$1$1 ==.
;	../CAN.C:742: CAN_vWriteCANAddress(CAN_MOIPR(ubObjNr));
	mov	a,#0x02
	add	a,_CAN_vGetMsgObj_sloc1_1_0
	mov	_CAN_ADL,a
	mov	a,#0x02
	...
	mov	_CAN_ADH,r4
	C$CAN.C$743$1$1 ==.
;	../CAN.C:743: CAN_vReadEN();   // Readmode is Enabled
	mov	_CAN_ADCON,#0x00
00130$:
	mov	a,_CAN_ADCON
	jb	acc.1,00130$
	C$CAN.C$745$1$1 ==.
;	../CAN.C:745: pstObj->uwCounter.ubDB[0] = CAN_DATA2;  // MOIPRn[16-23]
	mov	a,#0x12
	add	a,r5
	mov	r2,a
	clr	a
	...
	lcall	__gptrput
	C$CAN.C$746$1$1 ==.
;	../CAN.C:746: pstObj->uwCounter.ubDB[1] = CAN_DATA3;  // MOIPRn[31-24]
	mov	a,#0x12
	add	a,r5
	mov	r5,a
	clr	a
...
;------------------------------------------------------------
	G$CAN_vTransmit$0$0 ==.
	C$CAN.C$778$1$1 ==.
;	../CAN.C:778: void CAN_vTransmit(ubyte ubObjNr)
;	-----------------------------------------
...
_CAN_vTransmit:
	mov	r2,dpl
	C$CAN.C$780$1$1 ==.
;	../CAN.C:780: CAN_pushAMRegs();    //   PUSH the CAN Access Mediator Register
00101$:
	mov	a,_CAN_ADCON
	jb	acc.1,00101$
	 push 0xD9 push 0xDA push 0xDB push 0xDC push 0xDD push 0xDE 
	C$CAN.C$782$1$1 ==.
;	../CAN.C:782: CAN_vWriteCANAddress(CAN_MOCTR(ubObjNr));  //Addressing CAN_MOCTR register
	mov	a,r2
	swap	a
	rr	a
	anl	a,#0xf8
	...
	mov	_CAN_ADH,r3
	C$CAN.C$783$1$1 ==.
;	../CAN.C:783: CAN_vWriteCANData(0x07200000);      // set TXRQ,TXEN0,TXEN1,MSGVAL
	mov	_CAN_DATA0,#0x00
	mov	_CAN_DATA1,#0x00
	mov	_CAN_DATA2,#0x20
	mov	_CAN_DATA3,#0x07
...
00104$:
	...
	jb	acc.1,00104$
	C$CAN.C$785$1$1 ==.
;	../CAN.C:785: CAN_popAMRegs();    //   POP the CAN Access Mediator Register
	 pop 0xDE pop 0xDD pop 0xDC pop 0xDB pop 0xDA pop 0xD9 
	C$CAN.C$787$1$1 ==.
...
;------------------------------------------------------------
	G$CAN_vLoadData$0$0 ==.
	C$CAN.C$818$1$1 ==.
;	../CAN.C:818: void CAN_vLoadData(ubyte ubObjNr, ulong *ulpubData)
;	-----------------------------------------
...
_CAN_vLoadData:
	mov	r2,dpl
	C$CAN.C$820$1$1 ==.
;	../CAN.C:820: CAN_pushAMRegs();    //   PUSH the CAN Access Mediator Register
00101$:
	mov	a,_CAN_ADCON
	jb	acc.1,00101$
	 push 0xD9 push 0xDA push 0xDB push 0xDC push 0xDD push 0xDE 
	C$CAN.C$822$1$1 ==.
;	../CAN.C:822: CAN_vWriteCANAddress(CAN_MOCTR(ubObjNr));  // Addressing CAN_MOCTRn register
	mov	a,r2
	swap	a
	rr	a
	anl	a,#0xf8
	...
	mov	_CAN_ADH,r3
	C$CAN.C$823$1$1 ==.
;	../CAN.C:823: CAN_vWriteCANData(0x00080000);      // Set NEWDATA
	mov	_CAN_DATA0,#0x00
	mov	_CAN_DATA1,#0x00
	mov	_CAN_DATA2,#0x08
	mov	_CAN_DATA3,#0x00
...
00104$:
	...
	jb	acc.1,00104$
	C$CAN.C$826$1$1 ==.
;	../CAN.C:826: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$829$1$1 ==.
;	../CAN.C:829: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$832$1$1 ==.
;	../CAN.C:832: CAN_ADCON = ADR_DEC;   // Auto Decrement the current address(-1)
	mov	_CAN_ADCON,#0x08
	C$CAN.C$834$1$1 ==.
;	../CAN.C:834: CAN_vWriteCANData(*ulpubData); // Loading CAN_MODATALn
...
00107$:
	...
	jb	acc.1,00107$
	C$CAN.C$837$1$1 ==.
;	../CAN.C:837: CAN_ADCON = ADR_INC;   // Auto Increment the current address(+1)
	C$CAN.C$839$1$1 ==.
;	../CAN.C:839: ulpubData++;
	mov	a,#0x04
	mov	_CAN_ADCON,a
	...
	C$CAN.C$841$1$1 ==.
;	../CAN.C:841: CAN_vWriteCANData(*ulpubData); // Loading CAN_MODATAHn
...
00110$:
	...
	jb	acc.1,00110$
	C$CAN.C$844$1$1 ==.
;	../CAN.C:844: CAN_ADCON = ADR_INC;   // Auto Increment the current address(+1)
	mov	_CAN_ADCON,#0x04
	C$CAN.C$847$1$1 ==.
;	../CAN.C:847: CAN_ADCON = ADR_INC;   // Auto Increment the current address(+1)
	mov	_CAN_ADCON,#0x04
	C$CAN.C$849$1$1 ==.
;	../CAN.C:849: CAN_vWriteCANData(0x00200040);  // reset RTSEL, set MSGVAL
	mov	_CAN_DATA0,#0x40
	mov	_CAN_DATA1,#0x00
	mov	_CAN_DATA2,#0x20
	mov	_CAN_DATA3,#0x00
...
00113$:
	...
	jb	acc.1,00113$
	C$CAN.C$851$1$1 ==.
;	../CAN.C:851: CAN_popAMRegs();    //   POP the CAN Access Mediator Register
	 pop 0xDE pop 0xDD pop 0xDC pop 0xDB pop 0xDA pop 0xD9 
	C$CAN.C$853$1$1 ==.
