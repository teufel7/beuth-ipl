...
; This file was generated Thu Nov 28 10:57:43 2019
;--------------------------------------------------------
	.module SHARED_INT
...
;	../SHARED_INT.C:134: IEN0         |=  0x20;         // load interrupt enable register 0
	orl	_IEN0,#0x20
	C$SHARED_INT.C$138$1$1 ==.
;	../SHARED_INT.C:138: IEN1         |=  0x00;         // load interrupt enable register 1
	mov	_IEN1,_IEN1
	C$SHARED_INT.C$146$1$1 ==.
	XG$SHINT_vInit$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$SHARED_INT.C$190$1$1 ==.
;	../SHARED_INT.C:190: void SHINT_viXINTR5Isr(void) interrupt XINTR5INT
;	-----------------------------------------
...
;	../SHARED_INT.C:199: CAN_pushAMRegs();              // push the CAN Access Mediator Registers
00101$:
	mov	a,_CAN_ADCON
	jb	acc.1,00101$
	 push 0xD9 push 0xDA push 0xDB push 0xDC push 0xDD push 0xDE 
	C$SHARED_INT.C$201$1$1 ==.
;	../SHARED_INT.C:201: SFR_PAGE(_su0, SST0);          // switch to page 0
	mov	_SCU_PAGE,#0x80
	C$SHARED_INT.C$205$1$1 ==.
;	../SHARED_INT.C:205: if (TF2)
	C$SHARED_INT.C$209$2$2 ==.
;	../SHARED_INT.C:209: TF2 = 0;
	jbc	_TF2,00127$
	sjmp	00105$
00127$:
	C$SHARED_INT.C$212$2$2 ==.
;	../SHARED_INT.C:212: IO_vTogglePin(P3_7);
	cpl	_P3_7
	C$SHARED_INT.C$213$2$2 ==.
;	../SHARED_INT.C:213: CAN_vTransmit(0);
	mov	dpl,#0x00
...
;	../SHARED_INT.C:233: ubNSRL = CAN_DATA0;
	C$SHARED_INT.C$243$2$3 ==.
;	../SHARED_INT.C:243: if (ubNSRL & 0x18)  // if TXOK or RXOK
	mov	a,_CAN_DATA0
	mov	r2,a
	anl	a,#0x18
	jz	00110$
	C$SHARED_INT.C$254$3$4 ==.
;	../SHARED_INT.C:254: IO_vTogglePin(P3_6);
	cpl	_P3_6
00110$:
