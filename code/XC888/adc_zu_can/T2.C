...
void T2_vInit(void)
{
  ...
  ///  the timer 2 resolution is 0,167 us
  ///  the timer 2 overflow is 10000,000 us
  ...
  T2_T2LH       =  0x15A0;       // load timer 2 reload/capture register low 
                                 // & high bytes

  T2_RC2LH      =  0x15A0;       // load timer 2 reload/capture register low 
                                 // & high bytes
