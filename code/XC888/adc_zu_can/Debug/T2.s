...
_T2_vInit:
	...
	ar1 = 0x01
	C$T2.C$152$1$1 ==.
;	../T2.C:152: T2_T2LH       =  0x15A0;       // load timer 2 reload/capture register low 
	mov	_T2_T2LH,#0xA0
	mov	(_T2_T2LH >> 8),#0x15
	C$T2.C$155$1$1 ==.
;	../T2.C:155: T2_RC2LH      =  0x15A0;       // load timer 2 reload/capture register low 
	mov	_T2_RC2LH,#0xA0
	mov	(_T2_RC2LH >> 8),#0x15
	C$T2.C$157$1$1 ==.
;	../T2.C:157: T2_T2MOD      =  0x14;         // load timer 2 mode register
	mov	_T2_T2MOD,#0x14
	C$T2.C$164$1$1 ==.
