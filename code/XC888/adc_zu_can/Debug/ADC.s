...
; This file was generated Thu Nov 28 11:00:57 2019
;--------------------------------------------------------
	.module ADC
...
;--------------------------------------------------------
	...
	.globl _ADC_CHCTR0
	.globl _ACC
	.globl _ADC_vStartSeqReqChNum_PARM_4
	.globl _ADC_vStartSeqReqChNum_PARM_3
	.globl _ADC_vStartSeqReqChNum_PARM_2
	.globl _ADC_vInit
	.globl _ADC_vStartSeqReqChNum
	.globl _ADC_uwGetResultData0
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area DSEG    (DATA)
LADC_vStartSeqReqChNum$ubEnIntr$1$1==.
_ADC_vStartSeqReqChNum_PARM_2:
	.ds 1
LADC_vStartSeqReqChNum$ubRFill$1$1==.
_ADC_vStartSeqReqChNum_PARM_3:
	.ds 1
LADC_vStartSeqReqChNum$ubChannelNum$1$1==.
_ADC_vStartSeqReqChNum_PARM_4:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'ADC_vInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$ADC_vInit$0$0 ==.
	C$ADC.C$129$0$0 ==.
;	../ADC.C:129: void ADC_vInit(void)
;	-----------------------------------------
;	 function ADC_vInit
;	-----------------------------------------
_ADC_vInit:
	...
	ar1 = 0x01
	C$ADC.C$147$1$1 ==.
;	../ADC.C:147: SFR_PAGE(_ad0, noSST);         // switch to page 0
	mov	_ADC_PAGE,#0x00
	C$ADC.C$149$1$1 ==.
;	../ADC.C:149: ADC_GLOBCTR   =  0x70;         // load global control register
	mov	_ADC_GLOBCTR,#0x70
	C$ADC.C$162$1$1 ==.
;	../ADC.C:162: ADC_PRAR      =  0x40;         // load Priority and Arbitration register
	mov	_ADC_PRAR,#0x40
	C$ADC.C$164$1$1 ==.
;	../ADC.C:164: SFR_PAGE(_ad1, noSST);         // switch to page 1
	mov	_ADC_PAGE,#0x01
	C$ADC.C$173$1$1 ==.
;	../ADC.C:173: ADC_CHCTR7    =  0x40;         // load channel control register
	mov	_ADC_CHCTR7,#0x40
	C$ADC.C$175$1$1 ==.
;	../ADC.C:175: SFR_PAGE(_ad0, noSST);         // switch to page 0
	mov	_ADC_PAGE,#0x00
	C$ADC.C$181$1$1 ==.
;	../ADC.C:181: ADC_INPCR0    =  0x00;         // load input class register
	mov	_ADC_INPCR0,#0x00
	C$ADC.C$183$1$1 ==.
;	../ADC.C:183: SFR_PAGE(_ad4, noSST);         // switch to page 4
	mov	_ADC_PAGE,#0x04
	C$ADC.C$194$1$1 ==.
;	../ADC.C:194: ADC_RCR0      =  0x00;         // load result control register 0
	mov	_ADC_RCR0,#0x00
	C$ADC.C$202$1$1 ==.
;	../ADC.C:202: ADC_RCR1      =  0x00;         // load result control register 1
	mov	_ADC_RCR1,#0x00
	C$ADC.C$210$1$1 ==.
;	../ADC.C:210: ADC_RCR2      =  0x00;         // load result control register 2
	mov	_ADC_RCR2,#0x00
	C$ADC.C$218$1$1 ==.
;	../ADC.C:218: ADC_RCR3      =  0x00;         // load result control register 3
	mov	_ADC_RCR3,#0x00
	C$ADC.C$220$1$1 ==.
;	../ADC.C:220: SFR_PAGE(_ad5, noSST);         // switch to page 5
	mov	_ADC_PAGE,#0x05
	C$ADC.C$234$1$1 ==.
;	../ADC.C:234: ADC_CHINPR    =  0x00;         // load channel interrupt node pointer 
	mov	_ADC_CHINPR,#0x00
	C$ADC.C$247$1$1 ==.
;	../ADC.C:247: ADC_EVINPR    =  0x00;         // load event interrupt set flag register 
	mov	_ADC_EVINPR,#0x00
	C$ADC.C$249$1$1 ==.
;	../ADC.C:249: SFR_PAGE(_ad0, noSST);         // switch to page 0
	mov	_ADC_PAGE,#0x00
	C$ADC.C$255$1$1 ==.
;	../ADC.C:255: ADC_LCBR      =  0xB7;         // load limit check boundary register
	mov	_ADC_LCBR,#0xB7
	C$ADC.C$265$1$1 ==.
;	../ADC.C:265: ADC_ETRCR     =  0x00;         // load external trigger control register
	mov	_ADC_ETRCR,#0x00
	C$ADC.C$267$1$1 ==.
;	../ADC.C:267: SFR_PAGE(_ad6, noSST);         // switch to page 6
	mov	_ADC_PAGE,#0x06
	C$ADC.C$275$1$1 ==.
;	../ADC.C:275: ADC_QMR0      =  0x01;         // load queue mode register
	mov	_ADC_QMR0,#0x01
	C$ADC.C$285$1$1 ==.
;	../ADC.C:285: ADC_CRMR1     =  0x00;         // load conversion request mode register 1
	mov	_ADC_CRMR1,#0x00
	C$ADC.C$287$1$1 ==.
;	../ADC.C:287: SFR_PAGE(_ad0, noSST);         // switch to page 0
	mov	_ADC_PAGE,#0x00
	C$ADC.C$289$1$1 ==.
;	../ADC.C:289: ADC_GLOBCTR  |=  0x80;         // turn on Analog part
	orl	_ADC_GLOBCTR,#0x80
	C$ADC.C$297$1$1 ==.
	XG$ADC_vInit$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ADC_vStartSeqReqChNum'
;------------------------------------------------------------
;ubEnIntr                  Allocated with name '_ADC_vStartSeqReqChNum_PARM_2'
;ubRFill                   Allocated with name '_ADC_vStartSeqReqChNum_PARM_3'
;ubChannelNum              Allocated with name '_ADC_vStartSeqReqChNum_PARM_4'
;ubExtTrg                  Allocated to registers r2 
;ubVal                     Allocated to registers r3 
;------------------------------------------------------------
	G$ADC_vStartSeqReqChNum$0$0 ==.
	C$ADC.C$327$1$1 ==.
;	../ADC.C:327: void ADC_vStartSeqReqChNum(ubyte ubExtTrg, ubyte ubEnIntr, ubyte ubRFill, ubyte ubChannelNum)
;	-----------------------------------------
;	 function ADC_vStartSeqReqChNum
;	-----------------------------------------
_ADC_vStartSeqReqChNum:
	mov	r2,dpl
	C$ADC.C$330$1$1 ==.
;	../ADC.C:330: ubyte ubVal = 0;
	mov	r3,#0x00
	C$ADC.C$331$1$1 ==.
;	../ADC.C:331: if (ubExtTrg == 1){ ubVal = 0x80;}
	cjne	r2,#0x01,00102$
	mov	r3,#0x80
00102$:
	C$ADC.C$332$1$1 ==.
;	../ADC.C:332: if (ubEnIntr == 1){ ubVal = ubVal + 0x40;}
	mov	a,#0x01
	cjne	a,_ADC_vStartSeqReqChNum_PARM_2,00104$
	mov	a,#0x40
	add	a,r3
	mov	r3,a
00104$:
	C$ADC.C$333$1$1 ==.
;	../ADC.C:333: if (ubRFill == 1){ ubVal = ubVal + 0x20;}
	mov	a,#0x01
	cjne	a,_ADC_vStartSeqReqChNum_PARM_3,00106$
	mov	a,#0x20
	add	a,r3
	mov	r3,a
00106$:
	C$ADC.C$334$1$1 ==.
;	../ADC.C:334: ubVal = ubVal + (ubChannelNum & 0x07);
	mov	a,#0x07
	anl	a,_ADC_vStartSeqReqChNum_PARM_4
	add	a,r3
	mov	r3,a
	C$ADC.C$336$1$1 ==.
;	../ADC.C:336: SFR_PAGE(_ad6, SST1);          // switch to page 6
	mov	_ADC_PAGE,#0x96
	C$ADC.C$338$1$1 ==.
;	../ADC.C:338: ADC_QINR0 = ubVal; // requested channel 
	mov	_ADC_QINR0,r3
	C$ADC.C$340$1$1 ==.
;	../ADC.C:340: SFR_PAGE(_ad0, RST1);          // restore the old ADC page
	mov	_ADC_PAGE,#0xD0
	C$ADC.C$342$1$1 ==.
	XG$ADC_vStartSeqReqChNum$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ADC_uwGetResultData0'
;------------------------------------------------------------
;uwResult                  Allocated to registers r2 r3 
;------------------------------------------------------------
	G$ADC_uwGetResultData0$0$0 ==.
	C$ADC.C$363$1$1 ==.
;	../ADC.C:363: uword ADC_uwGetResultData0(void)
;	-----------------------------------------
;	 function ADC_uwGetResultData0
;	-----------------------------------------
_ADC_uwGetResultData0:
	C$ADC.C$365$1$1 ==.
;	../ADC.C:365: uword uwResult = 0;
	mov	r2,#0x00
	mov	r3,#0x00
	C$ADC.C$367$1$1 ==.
;	../ADC.C:367: SFR_PAGE(_ad2, SST1);          // switch to page 2
	mov	_ADC_PAGE,#0x92
	C$ADC.C$369$1$1 ==.
;	../ADC.C:369: if ( ADC_RESR0L & 0x10 )       //  if Result Register0 contains valid data
	mov	a,_ADC_RESR0L
	jnb	acc.4,00102$
	C$ADC.C$372$2$2 ==.
;	../ADC.C:372: uwResult = ADC_RESR0H;  // Result Register0 High
	mov	r2,_ADC_RESR0H
	mov	r3,#0x00
00102$:
	C$ADC.C$375$1$1 ==.
;	../ADC.C:375: SFR_PAGE(_ad0, RST1);          // restore the old ADC page
	mov	_ADC_PAGE,#0xD0
	C$ADC.C$377$1$1 ==.
;	../ADC.C:377: return(uwResult);
	mov	dpl,r2
	mov	dph,r3
	C$ADC.C$378$1$1 ==.
	XG$ADC_uwGetResultData0$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
