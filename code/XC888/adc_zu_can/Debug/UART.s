...
; This file was generated Thu Nov 28 11:01:00 2019
;--------------------------------------------------------
	.module UART
...
;--------------------------------------------------------
	...
	C$UART.C$201$1$1 ==.
;	../UART.C:201: static unsigned char txcount=0;
	mov	_txcount,#0x00
	G$UART_vSendData8$0$0 ==.
	C$UART.C$202$1$1 ==.
;	../UART.C:202: static int a = 0;
	clr	a
	mov	_a,a
	mov	(_a + 1),a
;--------------------------------------------------------
...
;------------------------------------------------------------
	G$UART_vInit$0$0 ==.
	C$UART.C$127$0$0 ==.
;	../UART.C:127: void UART_vInit(void)
;	-----------------------------------------
;	 function UART_vInit
;	-----------------------------------------
_UART_vInit:
	...
	ar1 = 0x01
	C$UART.C$142$1$1 ==.
;	../UART.C:142: SFR_PAGE(_pp2, noSST);         // switch to page 2 without saving
	mov	_PORT_PAGE,#0x02
	C$UART.C$143$1$1 ==.
;	../UART.C:143: P1_ALTSEL0   &= ~(ubyte)0x02;  // configure alternate function register 0
	anl	_P1_ALTSEL0,#0xFD
	C$UART.C$144$1$1 ==.
;	../UART.C:144: P1_ALTSEL1   |=  (ubyte)0x02;  // configure alternate function register 1
	orl	_P1_ALTSEL1,#0x02
	C$UART.C$145$1$1 ==.
;	../UART.C:145: SFR_PAGE(_pp0, noSST);         // switch to page 0 without saving
	mov	_PORT_PAGE,#0x00
	C$UART.C$146$1$1 ==.
;	../UART.C:146: P1_DIR       |=  (ubyte)0x02;  // set output direction
	orl	_P1_DIR,#0x02
	C$UART.C$148$1$1 ==.
;	../UART.C:148: BCON          =  0x00;         // reset baudrate timer/reload register
	mov	_BCON,#0x00
	C$UART.C$149$1$1 ==.
;	../UART.C:149: SCON          =  0x40;         // load serial channel control register
	mov	_SCON,#0x40
	C$UART.C$158$1$1 ==.
;	../UART.C:158: BG            =  0x9B;         // load baudrate timer/reload register
	mov	_BG,#0x9B
	C$UART.C$159$1$1 ==.
;	../UART.C:159: BCON         |=  0x01;         // load baud rate control register
	orl	_BCON,#0x01
	C$UART.C$167$1$1 ==.
;	../UART.C:167: ES = 1;
	setb	_ES
...
;------------------------------------------------------------
	G$UART_viIsr$0$0 ==.
	C$UART.C$206$1$1 ==.
;	../UART.C:206: void UART_viIsr(void) interrupt UARTINT
;	-----------------------------------------
;	 function UART_viIsr
;	-----------------------------------------
_UART_viIsr:
	...
	mov	psw,#0x00
	C$UART.C$212$1$1 ==.
;	../UART.C:212: SFR_PAGE(_su0, SST1);          // switch to page 0
	mov	_SCU_PAGE,#0x90
	C$UART.C$213$1$1 ==.
;	../UART.C:213: if (TI)
	C$UART.C$216$2$2 ==.
...
00110$:
	C$UART.C$217$2$2 ==.
;	../UART.C:217: a = ADC_uwGetResultData0();
	lcall	_ADC_uwGetResultData0
	mov	_a,dpl
	mov	(_a + 1),dph
	C$UART.C$218$2$2 ==.
;	../UART.C:218: sprintf(buf,"%d\r\n", a);
	push	_a
	push	(_a + 1)
	mov	a,#__str_0
	push	acc
...
;	../UART.C:219: if(buf[txcount]){
	...
	jz	00102$
	C$UART.C$220$3$3 ==.
;	../UART.C:220: UART_vSendData8(buf[txcount++]);
	mov	r2,_txcount
	inc	_txcount
	mov	a,r2
	add	a,#_buf
...
;	../UART.C:225: if (RI)
	mov	c,_RI
	C$UART.C$235$1$1 ==.
;	../UART.C:235: SFR_PAGE(_su0, RST1);          // restore the old page
	mov	_SCU_PAGE,#0xD0
	pop	psw
	pop	(0+1)
	pop	(0+0)
...
;------------------------------------------------------------
	G$UART_vSendData8$0$0 ==.
	C$UART.C$258$1$1 ==.
;	../UART.C:258: void UART_vSendData8(ubyte ubData)
;	-----------------------------------------
