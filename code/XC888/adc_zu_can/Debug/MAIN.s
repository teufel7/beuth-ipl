...
;	../MAIN.C:151: IO_vInit();
	lcall	_IO_vInit
	C$MAIN.C$154$1$1 ==.
;	../MAIN.C:154: UART_vInit();
	lcall	_UART_vInit
	C$MAIN.C$157$1$1 ==.
;	../MAIN.C:157: T2_vInit();
	lcall	_T2_vInit
	C$MAIN.C$160$1$1 ==.
;	../MAIN.C:160: ADC_vInit();
	lcall	_ADC_vInit
	C$MAIN.C$163$1$1 ==.
;	../MAIN.C:163: CAN_vInit();
	lcall	_CAN_vInit
	C$MAIN.C$166$1$1 ==.
;	../MAIN.C:166: SHINT_vInit();
	lcall	_SHINT_vInit
	C$MAIN.C$170$1$1 ==.
;	../MAIN.C:170: IP            =  0x10;         // load Interrupt Priority Register
	mov	_IP,#0x10
	C$MAIN.C$171$1$1 ==.
;	../MAIN.C:171: IPH           =  0x00;         // load Interrupt Priority High Register
	mov	_IPH,#0x00
	C$MAIN.C$172$1$1 ==.
;	../MAIN.C:172: IP1           =  0x00;         // load Interrupt Priority 1 Register
	mov	_IP1,#0x00
	C$MAIN.C$173$1$1 ==.
;	../MAIN.C:173: IPH1          =  0x00;         // load Interrupt Priority 1 High Register
	mov	_IPH1,#0x00
	C$MAIN.C$185$1$1 ==.
;	../MAIN.C:185: EA            =  1;           
	setb	_EA
